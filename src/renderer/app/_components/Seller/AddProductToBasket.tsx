import { Dialog, Divider, MenuItem, SelectField } from 'material-ui';
import React from 'react';
import styled from 'styled-components';

import { Category, Flavor, Product, ReceiptProduct } from '../../../../schemas';
...
export default class AddProductToBasket extends React.Component<Props, State> {
  ...
  get filteredProducts() {
    ...
    return this.props.products.filter(
      (el) => el.category === this.state.selectedCategoryId
    );
  }
