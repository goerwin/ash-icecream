...
import { Flavor, Product, ReceiptProduct } from '../../../../schemas';
  ...
  calculateInitialState(props: Props) {
    return {
      flavorsSelected: this.props.flavors.map((el, idx) =>
        el.flavorOptions.length === 1
          ? el.flavorOptions[0]
          : (this.props.productSelected &&
              this.props.productSelected.flavors[idx]) ||
            null
      ),
    };
  }
    ...
    return (
      ...
      >
        <ProductContent
          ...
          isHighlighted={
            this.props.productSelected &&
            this.props.productSelected.id === this.props.id
          }
        >
          ...
          <ProductContentPrice>
            {convertToPriceFormat(this.props.price)}
          </ProductContentPrice>
        </ProductContent>

        {this.props.flavors.length === 0 ? null : !this.state
            .showDropdown ? null : (
          <ProductFlavorPicker
